...
export interface INoticeQuery extends IQuery {
  noticeTitle?: string;
  publishName?: string;
  searchYear?: number;
  searchMonth?: number;
...
export class NoticeService extends Resource {
  ...
  get: ResourceMethod<{ id: any }, INotice>;

  @ResourceAction({
    method: RequestMethod.Patch
  })
  query: ResourceMethod<INoticeQuery, QueryResults<INotice>>;

  @ResourceAction({
    method: RequestMethod.Post
  })
  create: ResourceMethod<INotice, INotice>;

  @ResourceAction({
    method: RequestMethod.Put,
    path: '/{!id}'
  })
  update: ResourceMethod<INotice, INotice>;
