...
export interface IGradeQuery extends IQuery {
  id?: number;
  gradeYear?: Date;
  distiguishId?: number;
  searchYear?: number;
...
export class GradeService extends Resource {
  ...
  get: ResourceMethod<{ id: any }, IGrade>;

  @ResourceAction({
    method: RequestMethod.Patch
  })
  query: ResourceMethod<IGradeQuery, QueryResults<IGrade>>;

  @ResourceAction({
    method: RequestMethod.Post
  })
  create: ResourceMethod<IGrade, IGrade>;

  @ResourceAction({
    method: RequestMethod.Put,
    path: '/{!id}'
  })
  update: ResourceMethod<IGrade, IGrade>;
