...
export interface ICourseAllotQuery extends IQuery {
  userId?: number;
  courseId?: number;
  userType?: string;
}
...
@Injectable()
@ResourceParams({
  url: `${BASE_URL}/course_allot`
})

// 声明这个class叫TeacherService，名称自取
export class CourseAllotService extends Resource {
  ...
  get: ResourceMethod<{ id: any }, ICourseAllot>;

  @ResourceAction({
    method: RequestMethod.Patch
  })
  query: ResourceMethod<ICourseAllotQuery, QueryResults<ICourseAllot>>;

  @ResourceAction({
    method: RequestMethod.Post
  })
  create: ResourceMethod<ICourseAllot, ICourseAllot>;

  @ResourceAction({
    method: RequestMethod.Put,
    path: '/{!id}'
  })
  update: ResourceMethod<ICourseAllot, ICourseAllot>;
  ...
  @ResourceAction({
    path: '/updatesCourseAllot',
    method: RequestMethod.Post
  })
  updatesCourseAllot: ResourceMethod<ICourseAllot, ICourseAllot>;

  updateCourseAllot(data: ICourseAllot, callback?: (res: ICourseAllot) => any) {

    return this.updatesCourseAllot(data, callback);
