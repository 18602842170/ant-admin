...
export class StudentService extends Resource {
  ...
  get: ResourceMethod<{ id: any }, IStudent>;

  @ResourceAction({
    method: RequestMethod.Patch
  })
  query: ResourceMethod<IStudentQuery, QueryResults<IStudent>>;

  @ResourceAction({
    method: RequestMethod.Post
  })
  create: ResourceMethod<IStudent, IStudent>;

  @ResourceAction({
    method: RequestMethod.Put,
    path: '/{!id}'
  })
  update: ResourceMethod<IStudent, IStudent>;
  ...
  remove: ResourceMethod<{ id: any }, any>;
    ...
    // 通过id获取课程信息
    // @ResourceAction({
    //   path: '/findCourseInfor',
    //   method: RequestMethod.Get
    // })
    // findCourseInfor:  ResourceMethod<ICourseQuery,QueryResults<ICourse>>;
}
